...
async function startApplication() {
  ...
  const env_spec = ['https://cdn.holoviz.org/panel/0.14.0/dist/wheels/bokeh-2.4.3-py3-none-any.whl', 'https://cdn.holoviz.org/panel/0.14.0/dist/wheels/panel-0.14.0-py3-none-any.whl', 'aiofiles==22.1.0', 'aiohttp==3.8.4', 'aiosignal==1.3.1', 'aiosqlite==0.18.0', 'anyio==3.6.2', 'argon2-cffi==21.3.0', 'argon2-cffi-bindings==21.2.0', 'arrow==1.2.3', 'asttokens==2.2.1', 'async-timeout==4.0.2', 'attrs==22.2.0', 'Babel==2.12.1', 'backcall==0.2.0', 'bayesian-optimization==1.4.2', 'beautifulsoup4==4.11.2', 'bleach==6.0.0', 'bokeh==2.4.1', 'branca==0.6.0', 'certifi==2022.12.7', 'cffi==1.15.1', 'charset-normalizer==3.1.0', 'click==8.1.3', 'cloudpickle==2.2.1', 'colorama==0.4.6', 'colorcet==2.0.6', 'comm==0.1.2', 'contourpy==1.0.7', 'cycler==0.11.0', 'dask==2023.3.1', 'debugpy==1.6.6', 'decorator==5.1.1', 'defusedxml==0.7.1', 'exceptiongroup==1.1.1', 'executing==1.2.0', 'fastjsonschema==2.16.3', 'Flask==1.1.2', 'folium==0.14.0', 'fonttools==4.39.0', 'fqdn==1.5.1', 'frozenlist==1.3.3', 'fsspec==2023.3.0', 'greenlet==2.0.2', 'holoviews==1.14.2', 'hvplot==0.7.1', 'idna==3.4', 'iniconfig==2.0.0', 'invoke==1.3.0', 'ipykernel==6.21.3', 'ipython==8.11.0', 'ipython-genutils==0.2.0', 'ipywidgets==8.0.4', 'isoduration==20.11.0', 'itsdangerous==2.1.2', 'jedi==0.18.2', 'Jinja2==3.1.2', 'joblib==1.2.0', 'json5==0.9.11', 'jsonpointer==2.3', 'jsonschema==4.17.3', 'jupyter==1.0.0', 'jupyter-console==6.6.3', 'jupyter-events==0.6.3', 'jupyter-server==1.23.6', 'jupyter-ydoc==0.2.3', 'jupyter_client==8.0.3', 'jupyter_core==5.2.0', 'jupyter_server_fileid==0.8.0', 'jupyter_server_terminals==0.4.4', 'jupyter_server_ydoc==0.6.1', 'jupyterlab==3.6.1', 'jupyterlab-pygments==0.2.2', 'jupyterlab-widgets==3.0.5', 'jupyterlab_server==2.20.0', 'kaleido==0.2.1', 'kiwisolver==1.4.4', 'lab==7.3', 'locket==1.0.0', 'logzero==1.7.0', 'lxml==4.9.2', 'Markdown==3.4.1', 'MarkupSafe==2.0.1', 'matplotlib==3.7.1', 'matplotlib-inline==0.1.6', 'mistune==2.0.5', 'multidict==6.0.4', 'nbclassic==0.5.3', 'nbclient==0.7.2', 'nbconvert==7.2.10', 'nbformat==5.7.3', 'nest-asyncio==1.5.6', 'netaddr==0.8.0', 'notebook==6.5.3', 'notebook_shim==0.2.2', 'numerize==0.12', 'numpy==1.24.2', 'packaging==23.0', 'pandas==1.5.3', 'pandasql==0.7.3', 'pandocfilters==1.5.0', 'panel==0.14.0', 'param==1.12.0', 'parso==0.8.3', 'partd==1.3.0', 'patsy==0.5.3', 'pickleshare==0.7.5', 'Pillow==9.4.0', 'platformdirs==3.1.1', 'plotly==5.13.1', 'pluggy==1.0.0', 'prometheus-client==0.16.0', 'prompt-toolkit==3.0.38', 'psutil==5.9.4', 'pure-eval==0.2.2', 'pyarrow==11.0.0', 'pycparser==2.21', 'pyct==0.5.0', 'Pygments==2.14.0', 'pyparsing==3.0.9', 'pyrsistent==0.19.3', 'pytest==7.2.2', 'python-dateutil==2.8.2', 'python-json-logger==2.0.7', 'pytz==2022.1', 'pyviz-comms==2.2.1', 'pywin32==305', 'pywinpty==2.0.10', 'PyYAML==6.0', 'pyzmq==25.0.1', 'qtconsole==5.4.1', 'QtPy==2.3.0', 'redis==4.5.1', 'requests==2.28.2', 'researchpy==0.3.5', 'rfc3339-validator==0.1.4', 'rfc3986-validator==0.1.1', 'scikit-learn==1.2.2', 'scipy==1.10.1', 'seaborn==0.12.2', 'Send2Trash==1.8.0', 'simplejson==3.18.4', 'six==1.16.0', 'sniffio==1.3.0', 'soupsieve==2.4', 'SQLAlchemy==2.0.6', 'stack-data==0.6.2', 'statsmodels==0.13.5', 'tenacity==8.2.2', 'terminado==0.17.1', 'threadpoolctl==3.1.0', 'tinycss2==1.2.1', 'tomli==2.0.1', 'toolz==0.12.0', 'tornado==6.2', 'tqdm==4.65.0', 'traitlets==5.9.0', 'txt2tags==3.8', 'typing-extensions==3.10.0.2', 'umap==0.1.1', 'uri-template==1.2.0', 'urllib3==1.26.15', 'varint==1.0.2', 'wcwidth==0.2.6', 'webcolors==1.12', 'webencodings==0.5.1', 'websocket-client==1.5.1', 'Werkzeug==2.1.2', 'widgetsnbextension==4.0.5', 'xarray==2023.3.0', 'xgboost==1.7.4', 'XlsxWriter==3.0.9', 'y-py==0.5.9', 'yarl==1.8.2', 'ypy-websocket==0.8.2']
