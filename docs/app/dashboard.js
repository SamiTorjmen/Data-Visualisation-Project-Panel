...
# class ThemeSwitcher(param.Parameterized):
#     dark_mode = param.Boolean(default=False, label="Dark Mode")

#     @param.depends("dark_mode", watch=True)
#     def switch_theme(self):
#         if self.dark_mode:
#             pn.config.raw_css[-1] = DARK_THEME
#         else:
#             pn.config.raw_css[-1] = LIGHT_THEME

# theme_switcher = ThemeSwitcher()
# dark_mode_toggle = pn.widgets.Toggle(name="Dark Mode", width=100)
...
# pn.config.raw_css.append(LIGHT_THEME)
...
# pn.state.add_periodic_callback(update_theme, period=500)
